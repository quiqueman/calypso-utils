...
import calypsox.tk.bo.BOCacheDummyImpl;
import calypsox.tk.bo.cremapping.data.WorkingData;
...
public class UnitTestHelper {
	...
	// create a mock for the WorkingData, to use it
	// in mapping and cre sender
	this.workingData = mock(WorkingData.class);
	...
	Mockito.reset(this.workingData);
    ...
    public void setWorkingData(final WorkingData wd) {
	this.workingData = wd;
    }
